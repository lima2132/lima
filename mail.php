...
try {
  ...
  $mail->Username   = 'kir.lifshic11'; // Логин на почте
  $mail->Password   = 'tqrjtxrlbagywqbw'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('kir.lifshic11@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('kir.lifshic11@yandex.ru');
